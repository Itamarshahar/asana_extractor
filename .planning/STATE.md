...
- [Phase 12-incremental-extraction]: ExtractionState is mutable dataclass — updated in-place during cycle; atomic write via tmp+os.replace matching EntityWriter pattern
...
1. **Improve log output formatting for human readability** (general) — `.planning/todos/pending/2026-03-18-improve-log-output-formatting-for-human-readability.md`
